...
#ifdef CW_TEST
#define DEFAULT_CHANNEL CHANNEL_20				// test operation
#else
#define DEFAULT_CHANNEL CHANNEL_25				// normal operation
#endif
...
extern void SetTurboMode(int bEnable);
