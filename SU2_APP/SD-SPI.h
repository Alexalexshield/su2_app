...
#define SPIIN               TRISBbits.TRISB14  	// The TRIS bit for the SDI pin
#define SPIOUT              TRISFbits.TRISF5	// The TRIS bit for the SDO pin
#define SPICLOCK            TRISBbits.TRISB15   	// The TRIS bit for the SCK pin
...
//#define SD_CD_PULLUP		;
#define SD_CD_PULLUP		_CN17PUE=1; TRISBbits.TRISB13=0; _LATB13=0
